 ...
 * @author ana 
 */
public class Menu_1_JM_ADS_Adicao_Leitura_e_Aprendizagem extends javax.swing.JPanel {

    Home Home;
    Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte;
        
    public Menu_1_JM_ADS_Adicao_Leitura_e_Aprendizagem( Home Home2, Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte2 ) {
        Home = Home2;
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Exercícios - Adição", "/imagens_internas/livroTp.gif", new Exercicios_Indice_Adicao_Leitura_e_Aprendizagem(Home) ); 
...
//                Sistema_Home.Home.ControleTabs.AddTabsAoHome("FORNECEDORES", "/sistema_imagens/livroTp.gif", new fornecedor.Fornecedor_Home( Sistema_Home.Home ) );                   
    ...
    private void btExercicios8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios8MousePressed
        new Thread() {   @Override public void run() { try { 
            ...
            Home.ControleTabs.AddTabsAoHome("Adição", "/imagens_internas/livroTp.gif", 

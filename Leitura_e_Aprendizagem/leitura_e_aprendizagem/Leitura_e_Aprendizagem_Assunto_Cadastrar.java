 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Assunto_Cadastrar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Assunto_Cadastrar( Home Home2 ) {
        initComponents();
    ...
    public DefaultTableModel   tmPesquisa = new DefaultTableModel( null, new String[]{ 
        "ID", "CATEGORIA", "ENDEREÇO DO ARQUIVO HTML"        
    } );
    ...
    private void initComponents() {
        ...
        tfAssunto.setPreferredSize(new java.awt.Dimension(325, 43));
        tfAssunto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfAssuntoKeyPressed(evt);
            }
        });

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Nome da Assunto");
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addComponent(tfAssunto, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens_leitura_e_aprendizagem/salvar.gif"))); // NOI18N
        ...
        tfPaHtml.setPreferredSize(new java.awt.Dimension(325, 43));
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addComponent(tfPaHtml, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        );
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tfPaHtml, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        jButton6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens_leitura_e_aprendizagem/pesquisar.gif"))); // NOI18N
        ...
        lbImportacao1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens_leitura_e_aprendizagem/book_next.png"))); // NOI18N
        lbImportacao1.setToolTipText("CADASTRAR LIVRO");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbImportacao1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel11.setText("Cadastrar - Assunto - Leitura");
        ...
        jTabbedPane1.addTab("Cadastrar", Pergunta);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    */
    ...
    private void tfAssuntoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfAssuntoKeyPressed
        if( evt.getKeyCode() == KeyEvent.VK_ENTER )  {  
             
            //tfPesquisarPeloNomeProdutoControl();            
        }
    }//GEN-LAST:event_tfAssuntoKeyPressed
...
if( id_subcategoria > 0 ){    
            ...
            if( !tfAssunto.getText().trim().equals("") ){
                ...
                if( !tfPaHtml.getText().trim().equals("") ){
                    ...
                    if( assunto_do_db.equals("") ){
                        ...
                        ////////////////////////////////////////////////////////////////////
                        Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                        JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO ASSUNTO\n"
                            + "\nSTATUS DA CRIAÇÃO"
                    ...
                    JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO ASSUNTO\n"
                        + "\nSTATUS DA CRIAÇÃO"
                        + "\nPARA CRIAR O ASSUNTO INFORME O ENDEREÇO!\n"
                        + "\nOK PARA PROSSEGUIR."
                        ,"Class: " + this.getClass().getName(), 
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                    ////////////////////////////////////////////////////////////////////
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO ASSUNTO\n"
                    + "\nSTATUS DA CRIAÇÃO"
                    + "\nPARA CRIAR O ASSUNTO INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(), 
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
    JOPM JOptionPaneMod = new JOPM( 1, "CADASTRANDO ASSUNTO\n"
            + "\nSTATUS DO CADASTRO"
            + "\nNENHUMA SUBCATEGORIA SELECIONADA!\n"
            + "\nSELECIONE UMA SUBCATEGORIA PARA PESQUISAR.\n"    
            + "\nOK PARA PROSSEGUIR."
            ,"Class: " + this.getClass().getName(),
            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
    ////////////////////////////////////////////////////////////////////
    ...
    JOPM JOptionPaneMod = new JOPM( 1, "CADASTRANDO ASSUNTO\n"
            ...
            + "\nSELECIONE UMA MATÉRIA PARA PESQUISAR.\n"    
            + "\nOK PARA PROSSEGUIR."
            ,"Class: " + this.getClass().getName(),
            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
    ////////////////////////////////////////////////////////////////////

 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Subcategoria_Consultar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Subcategoria_Consultar( Home Home2 ) {
        initComponents();
            ...
            switch(comando){
                ...
                case "tudo":
                    ...
                    if( !material_do_db.equals("") ){
                        ...
                        int id_materia = 0;
                        try{
                            leitura_e_aprendizagem.BookInfo2 obj = (leitura_e_aprendizagem.BookInfo2) cbMateria.getSelectedItem();
                            id_materia = obj.ID;
                        }catch(Exception e){}
                ...
                case "id_materia":
                    ...
                    if( !material_do_db2.equals("") ){
                        ...
                        for (int i = 0; i < cbMateria.getItemCount(); i++){
                            ...
                            //System.out.println( "I: " + i + " - " +  "obj:" + obj.ID + " -- Subcategoria.getIdMateria(): " + Subcategoria.getIdMateria() );
    ...
    private void tbPesquisaLinhaSelecionada() { 
        try{
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                tfSubcategoria.setEditable(true);
    ...
    private void initComponents() {
        ...
        tfSubcategoria.setEditable(false);
        tfSubcategoria.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        tfSubcategoria.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        tfSubcategoria.setPreferredSize(new java.awt.Dimension(206, 26));
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGap(7, 7, 7)
                .addComponent(tfSubcategoria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel15.setText("Nome Para Pesquisar");
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tfPesquisarPeloNome, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addGap(0, 0, 0))
        );
        ...
        jLabel16.setText("Excluir Subategoria Selecionada");
        ...
        bt_criar_exe1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens_leitura_e_aprendizagem/java.gif"))); // NOI18N
        bt_criar_exe1.setText("Listar Todas");
        bt_criar_exe1.setToolTipText("Listar Todas As Subcategorias");
        ...
        jp_Opcoes_TabelaLayout.setHorizontalGroup(
            ...
            .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                ...
                .addGroup(jp_Opcoes_TabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(bt_criar_exe1, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                .addGroup(jp_Opcoes_TabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(bt_criar_exe1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(17, 17, 17)
                        .addComponent(jpExcluirSelecionado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel11.setText("Consultar - Subcategoria - Leitura");
...
if( id_Categoria > 0 ){             
            ...
            if( !tfSubcategoria.getText().trim().equals("") ){
                ...
                if( !tfPaHtml.getText().trim().equals("") ){
                    ...
                    try{ 
                        ...
                        Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM JM.SUBCATEGORIA WHERE SUBCATEGORIA = ? AND ID_CATEGORIA = ?", Subcategoria.class );
                        q.setParameter(1, tfSubcategoria.getText().trim().toUpperCase() );
                        q.setParameter(2, id_Categoria );
                        Lista_Book = q.getResultList();
                    }catch( Exception e ){ }
                    
                    String subcategoria_do_db = ""; try{ subcategoria_do_db = Lista_Book.get(0).getSubcategoria(); }catch( Exception e ){ subcategoria_do_db = ""; }
                    
                    if( subcategoria_do_db.equals("") ){
                        //Subcategoria = new Subcategoria();
                        Subcategoria.setIdMateria( id_Materia );
                        Subcategoria.setIdCategoria( id_Categoria );
                        Subcategoria.setSubcategoria( tfSubcategoria.getText().trim().toUpperCase() );
                        Subcategoria.setSubcategoriapaginahtml( tfPaHtml.getText().trim() );
                        ////////////////////////////////////////////////////////////////////
                        ...
                        ////////////////////////////////////////////////////////////////////
                        Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO SUBCATEGORIA\n"
                            + "\nSTATUS DA ALTERAÇÃO"
                            + "\nSUBCATEGORIA ALTERADA COM SUCESSO!\n"
                            + "\nOK PARA PROSSEGUIR."
                            ,"Class: " + this.getClass().getName(),
                            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                        ////////////////////////////////////////////////////////////////////   
                        ...
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO SUBCATEGORIA\n"
                            ...
                            + "\nSUBCATEGORIA JÁ EXISTE CADASTRADA\n"
                            + "\nOK PARA PROSSEGUIR."
                            ,"Class: " + this.getClass().getName(), 
                            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                        ////////////////////////////////////////////////////////////////////
                    ...
                    ////////////////////////////////////////////////////////////////////
                    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                    JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO SUBCATEGORIA\n"
                        + "\nSTATUS DA ALTERAÇÃO"
                        + "\nPARA ALTERAR A SUBCATEGORIA INFORME O ENDEREÇO!\n"
                        + "\nOK PARA PROSSEGUIR."
                        ,"Class: " + this.getClass().getName(),
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                    ////////////////////////////////////////////////////////////////////
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO SUBCATEGORIA\n"
                    + "\nSTATUS DA ALTERAÇÃO"
                    + "\nPARA ALTERAR A SUBCATEGORIA INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(),
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
    ...
    JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO SUBCATEGORIA\n"
            ...
            + "\nSELECIONE UM MATÉIA PARA PESQUISAR.\n"    
            + "\nOK PARA PROSSEGUIR."
            ,"Class: " + this.getClass().getName(),
            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
    ////////////////////////////////////////////////////////////////////
        ...
        try{
            ...
            if( tfPesquisarPeloNome.getText().trim().length() > 2 ){
                ...
                try{ 
                    if( cbCategoria.getItemCount() > 0 ) {
                        BookInfo2 obj = (BookInfo2) cbCategoria.getSelectedItem();
                        id_CategoriaPesquisa = obj.ID;
                    }
                }catch(Exception e){}
                
if( id_CategoriaPesquisa > 0 ){                
                //Tabela_Pesquisa_BD_Estabelecimento.setarCabecalhoTabelaGenerica();
                
                new Thread() {   @Override public void run() { try { Thread.sleep( 100 );
                
                List<Subcategoria> Lista_Subcategoria = null;
                try{
                    Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.SUBCATEGORIA WHERE SUBCATEGORIA LIKE ? AND ID_CATEGORIA = ?", Subcategoria.class );
                    q2.setParameter( 1, tfPesquisarPeloNome.getText().trim().toUpperCase() ); 
                    q2.setParameter(2, id_CategoriaPesquisa ); 
                    Lista_Subcategoria = q2.getResultList();
                }catch( Exception e ){}      
                                    
                String rbusca = ""; try{ rbusca = Lista_Subcategoria.get(0).getSubcategoria(); }catch( Exception e ){}
                                
                if( !rbusca.equals("") ){
                    while ( tmPesquisa.getRowCount() > 0){ tmPesquisa.removeRow(0); } 
                    tmPesquisa = new DefaultTableModel( null, new String[]{ 
                        "ID", "SUBCATEGORIA", "ENDEREÇO HTML SUBCATEGORIA" } );
                    tbPesquisa.setModel(tmPesquisa);                    
                    tabela_PreferedSize();
                    
                    int id = 0;
                    String subcategoria = "";
                    String subcategoria_html = "";
                    
                    Exportando = new Exportando("PROCURANDO DADOS...");
                    Exportando.setVisible(true);Exportando.pbg.setMinimum(0);
                    Exportando.pbg.setMaximum( Lista_Subcategoria.size() );

                    for (int i = 0; i < Lista_Subcategoria.size(); i++){                        
                        Exportando.pbg.setValue( i );                                                
////////////////////////////////////////////////////////////////////////////////                        
                        if(emexec == false){
                            tfPesquisarPeloNome();
...
////////////////////////////////////////////////////////////////////////////////                       
                        ...
                        try{ id             = Lista_Subcategoria.get(i).getId();                  }catch( Exception e ){}
                        try{ subcategoria      = Lista_Subcategoria.get(i).getSubcategoria();           }catch( Exception e ){}
                        try{ subcategoria_html = Lista_Subcategoria.get(i).getSubcategoriapaginahtml(); }catch( Exception e ){}

                        tmPesquisa.addRow(new Object[]{ id, subcategoria, subcategoria_html });
                    }
    ...
    ////////////////////////////////////////////////////////////////////
    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
    JOPM JOptionPaneMod = new JOPM( 1, "PESQUISAR SUBCATEGORIA\n"
            + "\nSTATUS DA PESQUISAR"
            + "\nNENHUMA SUBCATEGORIA LOCALIZADA!\n"
            + "\nSELECIONE UM CATEGORIA PRIMEIRO.\n"    
            + "\nOK PARA PROSSEGUIR."
            ,"Class: " + this.getClass().getName(),
            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
    ////////////////////////////////////////////////////////////////////
    ...
    private void btAlterar1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterar1MousePressed
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( response == JOptionPane.YES_OPTION){ 
                ...
                try {
                    DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( Subcategoria, JPAUtil.em()); 
                    DAOGenericoJPA2.excluir(); 
                }catch( Exception e ){} 
                
                ////////////////////////////////////////////////////////////////////
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "EXCLUINDO SUBCATEGORIA\n"
                    + "\nSTATUS DA EXCLUSÃO"
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            if( id_Materia > 0 ){
                ...
                try{
                    ...
                    System.out.println("BookInfoCategoria obj = " + id_Categoria);
                    e.printStackTrace(); 
                }

                //System.out.println("id_Categoria = " + id_Categoria);
                if( id_Categoria > 0 ){
                        //System.out.println("if( id_Categoria > 0 ){ = " + id_Categoria);
                        /////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        List<Subcategoria> Lista_Subcategoria = null;
                        try{
                            Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.SUBCATEGORIA WHERE ID_CATEGORIA = ?", Subcategoria.class );
                            q2.setParameter( 1, id_Categoria );
                            Lista_Subcategoria = q2.getResultList();
                        }catch( Exception e ){}
                ...
                ////////////////////////////////////////////////////////////////////
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "PESQUISANDO SUBCATEGORIA\n"
                    + "\nSTATUS DA PESQUISA"
                    + "\nNENHUMA CATEGORIA SELECIONADA!\n"
                    + "\nSELECIONE UMA CATEGORIA PARA PESQUISAR.\n"
                    + "\nOK PARA PROSSEGUIR."
    ...
    private void bt_criar_exe1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_criar_exe1MouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_bt_criar_exe1MouseExited
    ...
    private void procurar_valor_tabela_selecionada() {                                              
        try {  
            ...
            if( !material_do_db.equals("") ){
                Subcategoria = Lista_Book.get(0);
                
                //setarCBMateria("id_materia",Subcategoria.getIdMateria());
                tfSubcategoria.setText(Subcategoria.getSubcategoria() );
                tfPaHtml.setText(Subcategoria.getSubcategoriapaginahtml() );
            }          
        }catch(Exception e){} 
    }

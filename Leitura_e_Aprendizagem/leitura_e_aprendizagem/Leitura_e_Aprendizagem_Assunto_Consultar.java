 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Assunto_Consultar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Assunto_Consultar( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfAssunto.setEditable(false);
        tfAssunto.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        tfAssunto.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        tfAssunto.setPreferredSize(new java.awt.Dimension(206, 26));
        ...
        jLabel16.setText("Assunto Selecionado");
        ...
        jpExcluirSelecionadoLayout.setHorizontalGroup(
            ...
            .addGroup(jpExcluirSelecionadoLayout.createSequentialGroup()
                .addComponent(btAlterar1, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(6, 6, 6)
        ...
        jpExcluirSelecionadoLayout.setVerticalGroup(
            ...
            .addGroup(jpExcluirSelecionadoLayout.createSequentialGroup()
                ...
                .addGroup(jpExcluirSelecionadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpExcluirSelecionadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        bt_criar_exe1.setToolTipText("Criar Exercícios");
            ...
            .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                .addGroup(jp_Opcoes_TabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addGroup(jp_Opcoes_TabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cbSubcategoria, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        ...
        jLabel11.setText("Consultar - Assunto - Leitura");
        ...
        PerguntaLayout.setVerticalGroup(
            ...
            .addGroup(PerguntaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jp_Opcoes_Tabela, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
if( id_subcategoria > 0 ){ 
            ...
            if( !tfAssunto.getText().trim().equals("") ){

                if( !tfPaHtml.getText().trim().equals("") ){
                    List<Assunto> Lista_Book = null;
                    try{ 
                        
                        Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM JM.ASSUNTO WHERE ASSUNTO = ? AND ID_SUBCATEGORIA = ?", Assunto.class );
                        q.setParameter(1, tfAssunto.getText().trim().toUpperCase() );
                        q.setParameter(2, id_subcategoria );
                        Lista_Book = q.getResultList();
                    }catch( Exception e ){ }
                    ...
                    if( assunto_do_db.equals("") ){
                        //Assunto = new Assunto();
                        Assunto.setIdMateria( id_Materia );
                        Assunto.setIdCategoria( id_Categoria );
                        Assunto.setIdSubcategoria( id_subcategoria );
                        Assunto.setAssunto( tfAssunto.getText().trim().toUpperCase() );
                        Assunto.setAssuntopaginahtml( tfPaHtml.getText().trim() );
                        ////////////////////////////////////////////////////////////////////
                        ...
                        ////////////////////////////////////////////////////////////////////
                        Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO ASSUNTO\n"
                            + "\nSTATUS DA ALTERAÇÃO"
                        ...
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO ASSUNTO\n"
                            + "\nSTATUS DA ALTERAÇÃO"
                            + "\nASSUNTO NÃO ALTERADO!\n"
                            + "\nASSUNTO JÁ EXISTE CADASTRADO\n"
                            + "\nOK PARA PROSSEGUIR."
                            ,"Class: " + this.getClass().getName(), 
                            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                        ////////////////////////////////////////////////////////////////////
                    ...
                    ////////////////////////////////////////////////////////////////////
                    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                    JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO ASSUNTO\n"
                        + "\nSTATUS DA ALTERAÇÃO"
                        + "\nPARA ALTERAR O ASSUNTO INFORME O ENDEREÇO!\n"
                        + "\nOK PARA PROSSEGUIR."
                        ,"Class: " + this.getClass().getName(),
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                    ////////////////////////////////////////////////////////////////////
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO ASSUNTO\n"
                    + "\nSTATUS DA ALTERAÇÃO"
                    + "\nPARA ALTERAR O ASSUNTO INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(),
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
    ...
    private void btAlterar1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterar1MousePressed
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            int response = JOptionPane.showConfirmDialog(null, ""
                    + "**CONFIRMAR EXCLUSÃO**"
                    + "\n"
                    + "Deseja Excluir Esta Assunto?");
            if( response == JOptionPane.YES_OPTION){ 
                
                try {
                    DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( Assunto, JPAUtil.em()); 
                    DAOGenericoJPA2.excluir(); 
                }catch( Exception e ){} 
                
                ////////////////////////////////////////////////////////////////////
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "EXCLUINDO ASSUNTO\n"
                    + "\nSTATUS DA EXCLUSÃO"
    ...
    private void procurar_valor_tabela_selecionada() {                                              
        try {  
            ...
            if( !assunto_do_db.equals("") ){
                ...
                tfAssunto.setText(Assunto.getAssunto() );
                tfPaHtml.setText(Assunto.getAssuntopaginahtml() );            

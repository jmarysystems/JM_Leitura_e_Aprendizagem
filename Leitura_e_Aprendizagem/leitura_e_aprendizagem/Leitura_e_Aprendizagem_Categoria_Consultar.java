 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Categoria_Consultar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Categoria_Consultar( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfCategoria.setEditable(false);
        tfCategoria.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        tfCategoria.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        tfCategoria.setPreferredSize(new java.awt.Dimension(206, 26));
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGap(7, 7, 7)
                .addComponent(tfCategoria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel16.setText("Excluir Categoria Selecionada");
        ...
        jp_Opcoes_TabelaLayout.setHorizontalGroup(
            ...
            .addGroup(jp_Opcoes_TabelaLayout.createSequentialGroup()
                ...
                .addGroup(jp_Opcoes_TabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(bt_criar_exe1, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel11.setText("Consultar - Categoria - Leitura");
            ...
            if( !tfCategoria.getText().trim().equals("") ){
                ...
                if( !tfPaHtml.getText().trim().equals("") ){
                    ...
                    try{ 
                        ...
                        Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM JM.CATEGORIA WHERE CATEGORIA = ? AND ID_MATERIA = ?", Categoria.class );
                        q.setParameter(1, tfCategoria.getText().trim().toUpperCase() );
                        q.setParameter(2, id_Materia );
                        Lista_Book = q.getResultList();
                    }catch( Exception e ){ }
                    
                    String categoria_do_db = ""; try{ categoria_do_db = Lista_Book.get(0).getCategoria(); }catch( Exception e ){ categoria_do_db = ""; }
                    
                    if( categoria_do_db.equals("") ){
                        //Materia Categoria = new Categoria();
                        Categoria.setIdMateria( id_Materia );
                        Categoria.setCategoria( tfCategoria.getText().trim().toUpperCase() );
                        Categoria.setCategoriapaginahtml( tfPaHtml.getText().trim() );
                        ////////////////////////////////////////////////////////////////////
                        ...
                        ////////////////////////////////////////////////////////////////////
                        Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO CATEGORIA\n"
                            + "\nSTATUS DA ALTERAÇÃO"
                        ...
                        JOPM JOptionPaneMod = new JOPM( 1, "ALTERANDO CATEGORIA\n"
                            + "\nSTATUS DA ALTERAÇÃO"
                            + "\nCATEGORIA NÃO ALTERAÇDA!\n"
                            + "\nCATEGORIA JÁ EXISTE CADASTRADA\n"
                            + "\nOK PARA PROSSEGUIR."
                            ,"Class: " + this.getClass().getName(), 
                            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                        ////////////////////////////////////////////////////////////////////
                    ...
                    ////////////////////////////////////////////////////////////////////
                    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                    JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO CATEGORIA\n"
                        + "\nSTATUS DA CRIAÇÃO"
                        + "\nPARA CRIAR A CATEGORIA INFORME O ENDEREÇO!\n"
                        + "\nOK PARA PROSSEGUIR."
                        ,"Class: " + this.getClass().getName(),
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                    ////////////////////////////////////////////////////////////////////
                ...
                ////////////////////////////////////////////////////////////////////
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "ALTERAÇÃO CATEGORIA\n"
                    + "\nSTATUS DA ALTERAÇÃO"
                    + "\nNENHUMA CATEGORIA SELECIONADA!\n"
                    + "\nSELECIONE UM CATEGORIA NA TABELA.\n"    
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(),
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
        ...
        try{
            ...
            if( tfPesquisarPeloNome.getText().trim().length() > 2 ){
                ...
                try{ 
                    if( cbMateria.getItemCount() > 0 ) {
                        BookInfo2 obj = (BookInfo2) cbMateria.getSelectedItem();
                        id_MateriaPesquisa = obj.ID;
                    }
                }catch(Exception e){}
                
if( id_MateriaPesquisa > 0 ){                
                ...
                try{
                    Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.CATEGORIA WHERE CATEGORIA LIKE ? AND ID_MATERIA = ?", Categoria.class );
                    q2.setParameter( 1, tfPesquisarPeloNome.getText().trim().toUpperCase() ); 
                    q2.setParameter( 2, id_MateriaPesquisa ); 
                    Lista_Categoria = q2.getResultList();
                }catch( Exception e ){}      
                                    
                String rbusca = ""; try{ rbusca = Lista_Categoria.get(0).getCategoria(); }catch( Exception e ){}
                ...
                if( !rbusca.equals("") ){
                    ...
                    int id = 0;
                    String categoria = "";
                    String categoria_html = "";
                    
                    Exportando = new Exportando("PROCURANDO DADOS...");
                    Exportando.setVisible(true);Exportando.pbg.setMinimum(0);
                    Exportando.pbg.setMaximum( Lista_Categoria.size() );
...
////////////////////////////////////////////////////////////////////////////////                       
                        ...
                        try{ id             = Lista_Categoria.get(i).getId();                  }catch( Exception e ){}
                        try{ categoria      = Lista_Categoria.get(i).getCategoria();           }catch( Exception e ){}
                        try{ categoria_html = Lista_Categoria.get(i).getCategoriapaginahtml(); }catch( Exception e ){}

                        tmPesquisa.addRow(new Object[]{ id, categoria, categoria_html });
                    }
    ...
    ////////////////////////////////////////////////////////////////////
    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
    JOPM JOptionPaneMod = new JOPM( 1, "PESQUISAR CATEGORIA\n"
            + "\nSTATUS DA PESQUISAR"
            + "\nNENHUMA MATÉRIA LOCALIZADA!\n"
            + "\nSELECIONE UM MATÉRIA PRIMEIRO.\n"    
            + "\nOK PARA PROSSEGUIR."
            ,"Class: " + this.getClass().getName(),
            new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
    ////////////////////////////////////////////////////////////////////
    ...
    private void btAlterar1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterar1MousePressed
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( response == JOptionPane.YES_OPTION){ 
                ...
                try {
                    DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( Categoria, JPAUtil.em()); 
                    DAOGenericoJPA2.excluir(); 
                }catch( Exception e ){} 
                
                ////////////////////////////////////////////////////////////////////
                Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                JOPM JOptionPaneMod = new JOPM( 1, "EXCLUINDO CATEGORIA\n"
                    + "\nSTATUS DA EXCLUSÃO"
    ...
    private void bt_criar_exe1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_criar_exe1MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            if( id_Materia > 0 ){
                    ...
                    List<Categoria> Lista_Categoria = null;
                    try{
                        Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.CATEGORIA WHERE ID_MATERIA = ?", Categoria.class );
                        q2.setParameter( 1, id_Materia );
                        Lista_Categoria = q2.getResultList();
                    }catch( Exception e ){}
    ...
    private void procurar_valor_tabela_selecionada() {                                              
        try {  
            ...
            try{
                ...
                Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM JM.CATEGORIA WHERE ID = ?", Categoria.class );
                q.setParameter(1, id );
                Lista_Book = q.getResultList();
            }catch( Exception e ){ }
            ...
            if( !material_do_db.equals("") ){
                ...
                Categoria = Lista_Book.get(0);
                
                //setarCBMateria("id_materia",Categoria.getIdMateria());
                
                tfCategoria.setText(Categoria.getCategoria() );
                tfPaHtml.setText(Categoria.getCategoriapaginahtml() );
            }        
        }catch(Exception e){} 
    }

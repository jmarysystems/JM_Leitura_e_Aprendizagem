 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Subcategoria_Cadastrar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Subcategoria_Cadastrar( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfSubcategoria.setPreferredSize(new java.awt.Dimension(325, 43));
        tfSubcategoria.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfSubcategoriaKeyPressed(evt);
            }
        });
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addComponent(tfSubcategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        jLabel11.setText("Cadastrar - Subcategoria - Leitura");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    */
    ...
    private void tfSubcategoriaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSubcategoriaKeyPressed
        if( evt.getKeyCode() == KeyEvent.VK_ENTER )  {  
             
            //tfPesquisarPeloNomeProdutoControl();            
        }
    }//GEN-LAST:event_tfSubcategoriaKeyPressed
...
if( id_Categoria > 0 ){            
            ...
            if( !tfSubcategoria.getText().trim().equals("") ){
                ...
                if( !tfPaHtml.getText().trim().equals("") ){
                    ...
                    if( subcategoria_do_db.equals("") ){
                        ...
                        ////////////////////////////////////////////////////////////////////
                        Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
                        JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO SUBCATEGORIA\n"
                            + "\nSTATUS DA CRIAÇÃO"
                    ...
                    JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO SUBCATEGORIA\n"
                        + "\nSTATUS DA CRIAÇÃO"
                        + "\nPARA CRIAR A SUBCATEGORIA INFORME O ENDEREÇO!\n"
                        + "\nOK PARA PROSSEGUIR."
                        ,"Class: " + this.getClass().getName(), 
                        new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                    ////////////////////////////////////////////////////////////////////
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO SUBCATEGORIA\n"
                    + "\nSTATUS DA CRIAÇÃO"
                    + "\nPARA CRIAR A SUBCATEGORIA INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(), 
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
    JOPM JOptionPaneMod = new JOPM( 1, "CADASTRANDO SUBCATEGORIA\n"
            + "\nSTATUS DO CADASTRO"

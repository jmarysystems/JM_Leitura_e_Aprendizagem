 ...
 * @author Ana
 */
public class O3_Imprimir_JEditorPane_Html extends Thread { 
    ...
    public O3_Imprimir_JEditorPane_Html( JEditorPane htmlPanePrincipal2  ){   
        htmlPanePrincipal = htmlPanePrincipal2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////                          
            ...
            //}while(count < lista_Arquivos.size());            
                ...
                JOPM JOPM = new JOPM( 2, "setar_JEditorPane(), \n"+ e.getMessage() + "\n", this.getClass().getSimpleName() ); }
        ...
        */
        ...
        synchronized(this) {
            ...
            try {  
                ...
                Exportando.fechar();
                e.printStackTrace(); JOPM JOPM = new JOPM( 2, "imprimirComPropriedadesEConfigurações( PrinterJob pJob, String NomeDoc ), \n"+ e.getMessage() + "\n", this.getClass().getSimpleName() );
            }

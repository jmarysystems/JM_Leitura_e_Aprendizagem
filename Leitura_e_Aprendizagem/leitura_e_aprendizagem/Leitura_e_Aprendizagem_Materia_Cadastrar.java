 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Materia_Cadastrar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Materia_Cadastrar( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfMateria.setPreferredSize(new java.awt.Dimension(325, 43));
        tfMateria.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfMateriaKeyPressed(evt);
            }
        });
        ...
        jLabel11.setText("Cadastrar - Matéria - Leitura");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    */
    ...
    private void tfMateriaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfMateriaKeyPressed
        if( evt.getKeyCode() == KeyEvent.VK_ENTER )  {  
             
            //tfPesquisarPeloNomeProdutoControl();            
        }
    }//GEN-LAST:event_tfMateriaKeyPressed
    ...
    private void jButton5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( !tfMateria.getText().trim().equals("") ){
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO MATÉRIA\n"
                    + "\nSTATUS DA CRIAÇÃO"
                    + "\nPARA CRIAR A MATÉRIA INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(), 
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////

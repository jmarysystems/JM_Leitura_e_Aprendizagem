 ...
 * @author AnaMariana
 */
public class Leitura_e_Aprendizagem_Categoria_Cadastrar extends javax.swing.JPanel {
    
    Home Home;
    
    /** Creates new form SombraVendas
     * @param Home2 */
    public Leitura_e_Aprendizagem_Categoria_Cadastrar( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfCategoria.setPreferredSize(new java.awt.Dimension(325, 43));
        tfCategoria.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfCategoriaKeyPressed(evt);
            }
        });
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addComponent(tfCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        jLabel11.setText("Cadastrar - Categoria - Leitura");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    */
    ...
    private void tfCategoriaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfCategoriaKeyPressed
        if( evt.getKeyCode() == KeyEvent.VK_ENTER )  {  
             
            //tfPesquisarPeloNomeProdutoControl();            
        }
    }//GEN-LAST:event_tfCategoriaKeyPressed
...
if( id_Materia > 0 ){
            ...
            if( !tfCategoria.getText().trim().equals("") ){
                ...
                JOPM JOptionPaneMod = new JOPM( 1, "CRIANDO CATEGORIA\n"
                    + "\nSTATUS DA CRIAÇÃO"
                    + "\nPARA CRIAR A CATEGORIA INFORME O NOME!\n"
                    + "\nOK PARA PROSSEGUIR."
                    ,"Class: " + this.getClass().getName(), 
                    new ImageIcon( clazzHome.getResource("logocangaco2.png")) );
                ////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
    Class<Imagens_Internas> clazzHome = Imagens_Internas.class;
    JOPM JOptionPaneMod = new JOPM( 1, "CADASTRANDO CATEGORIA\n"
            + "\nSTATUS DO CADASTRO"
